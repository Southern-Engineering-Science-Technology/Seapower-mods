...
def main():
    ...
    if "Eastern Sweep" in text:
        print(f"{args.mission}: eastern air group already present — nothing to do")
        return
    ...
    print(f"{args.mission}: +{added} red aircraft (Taskforce2 now {n})")
    if args.write:
