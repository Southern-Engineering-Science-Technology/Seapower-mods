...
|---|---|---|
| **Sanctioned Convoy Intercept** | 83 | Three sanctioned tanker lifts are running out of Bayu-Undan, Ichthys and Montara under escort. A RAN inshore screen and a single strike pair have to sort neutral traffic from sanctioned traffic and stop the latter. Includes the full civilian layer. |
...
| **Carrier Duel** | 14 | A Ford-class group and a PLAN carrier group in the same water, each with its own escort and air wing, and nothing else to hide behind. |
...
| **Boomer Hunt** | 77 | A PLAN SSBN group is transiting with escort. A NATO surface group and a single ASW pair have to find it before it reaches open water. Includes the full civilian layer. |
