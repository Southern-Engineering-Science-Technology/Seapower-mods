<#
.SYNOPSIS
    Install (or update) the five SEST packs into Sea Power's StreamingAssets folder.
...
.DESCRIPTION
    ...
    copies the five SEST pack folders from this repo's integration\ directories
...
Write-Host "Next: launch Sea Power -> Mod Manager -> enable the five SEST entries and set the order"
Write-Host "(see docs\setup-runbook.md Phase 4 - the three SEST loadout patches must sit ABOVE their targets)."
